...
const Footer: React.FunctionComponent = () => {
    return (
      <div className="w-full font-sans text-light-text">
          ...
          <div
            className="w-full bg-dark-bg flex flex-col justify-center text-center items-center py-2 ">
              <h1 className="text-3xl lg:text-4xl text-light-text tracking-widest font-semibold">
                  Contribute
              </h1>
              <div
                className="w-full font-medium my-6 lg:px-[5%] flex flex-col lg:gap-[10%] lg:flex-row items-center lg:items-start justify-evenly lg:justify-between">
                  <Contribution
