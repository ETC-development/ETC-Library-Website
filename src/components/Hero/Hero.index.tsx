...
const Hero: React.FunctionComponent = () => {
    return (
        <div className="flex flex-col bg-dark-bg text-light-text font-sans">
            ...
            <div className="bg-dark-bg mt-[70px] lg:h-fit w-full flex-grow-0 flex-shrink flex flex-no-wrap flex-col-reverse justify-center content-center px-2 lg:flex-row lg:flex-row lg:justify-around lg:px-10">
                ...
                <div className="my-6 flex flex-col w-full lg:w-100 justify-center content-center">
                    <img className="m-auto w-96 lg:w-full" src="" />
